...
export class AddProductDialogComponent {
  ...
  public dialogForm: FormGroup = new FormGroup({
    name: new FormControl<string>("", { validators: this.formNameFieldValidators }),
    image: new FormControl<File>({} as File, { validators: this.formImageFieldValidators }),
    stock: new FormControl<string>("", { validators: this.formStockFieldValidators }),
    cost: new FormControl<string>("", { validators: this.formCostFieldValidators }),
    price: new FormControl<string>("", { validators: this.formPriceFieldValidators }),
    category: new FormControl<string>("", { validators: this.formCategoryFieldValidators }),
    available: new FormControl<string>("", { validators: this.formAvailableFieldValidators })
  });
