...
export class RegisterPageComponent {
    ...
    public registerForm: FormGroup = new FormGroup({
      username: new FormControl<string>("", { validators: this.validator.username }),
      lastName: new FormControl<string>("", { validators: this.validator.password }),
      email: new FormControl<string>("", { validators: this.validator.email }),
      password: new FormControl<string>("", { validators: this.validator.password }),
      confirmPassword: new FormControl<string>("", { validators: this.validator.confirmPassword }),
    });
